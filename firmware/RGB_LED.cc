...
void setDefaultColor(){
	 ...
	 uint8_t LEDColor = 1; //eeprom::getEeprom8(eeprom_offsets::LED_STRIP_SETTINGS, 1);
	 uint32_t CustomColor = 0xffffffff; // eeprom::getEeprom32(eeprom_offsets::LED_STRIP_SETTINGS + blink_eeprom_offsets::CUSTOM_COLOR, 0xFFFFFFFF);
