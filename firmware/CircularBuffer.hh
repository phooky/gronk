...
template <typename T> class CircularBufferTempl {
public:
...
public:
  ...
  inline const BufSizeType getLength() const { return length; }
  ...
  inline const bool isEmpty() const { return length == 0; }
  ...
  inline const bool hasOverflow() const { return overflow; }
  /// Check the underflow flag
  inline const bool hasUnderflow() const { return underflow; }
};
